...
import LOGO from "./../public/icons/recall.png"
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    //run the logo for 3 seconds with bouncing effect before main app shows
    setInterval(() => {
      setShowLogo(false)
    }, 2500);
    setShowLogo(true)
  ...
  return (
    <>
      {showLogo ?
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0F1729] logo rounded-2xl">
          <Image loading="eager" src={LOGO} alt="Recall Logo" width={150} height={150} className="animate-pulse rounded-2xl" />
        </div> :
